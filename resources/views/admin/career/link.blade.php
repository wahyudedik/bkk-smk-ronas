...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.career.storeLink') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="apply_url" class="form-label">URL Lamaran</label>
                <input type="url" class="form-control" id="apply_url" name="apply_url" required>
            </div>
            <div class="mb-3">
                <label for="batas_waktu" class="form-label">Batas Waktu Lamaran</label>
                <input type="date" class="form-control" id="batas_waktu" name="batas_waktu" value="{{ old('batas_waktu') }}">
            </div>
