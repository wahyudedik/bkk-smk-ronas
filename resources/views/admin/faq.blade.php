                ...
                <div class="card basic">
                    <div class="card-body">
                        ...
                        <div class="pt-2">
                            ...
                            <p>You can schedule a blog post to be published in the future by choosing a date and time in the publishing options when creating a new post.</p>
                        </div>

                        <div class="pt-2">
                            <h6>2. Blog Post Categories</h6>
                            <p>You can add categories to your blog posts by choosing one or more categories in the publishing options when creating a new post.</p>
                        </div>

                        <div class="pt-2">
                            <h6>3. Blog Search</h6>
                            <p>You can search for blog posts on the homepage by typing a keyword or phrase in the search bar at the top of the page.</p>
                        </div>

                        <div class="pt-2">
                            <h6>4. Blog Post Tags</h6>
                            <p>You can add tags to your blog posts by choosing one or more tags in the publishing options when creating a new post.</p>
                        </div>

                        <div class="pt-2">
                            <h6>5. Blog Post Comments</h6>
                            <p>You can enable comments on your blog posts by checking the "Enable Comments" checkbox in the publishing options when creating a new post.</p>
                        </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqsOne-1" class="accordion-collapse collapse" data-bs-parent="#faq-group-1">
                                    <div class="accordion-body">
                                        ...
                                        Setelah itu, lowongan pekerjaan Anda akan tersedia di halaman utama Career Center dan bisa dibaca oleh pelamar yang tertarik dengan pekerjaan itu.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqsTwo-2" class="accordion-collapse collapse" data-bs-parent="#faq-group-2">
                                    <div class="accordion-body">
                                        ...
                                        Setelah itu, laporan Anda akan diupdate dan akan terlihat pada halaman utama laporan Anda.
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="faqsTwo-3" class="accordion-collapse collapse" data-bs-parent="#faq-group-2">
                                    <div class="accordion-body">
                                        ...
                                        <ol>
                                            ...
                                            <li>Konfirmasi penghapusan dengan mengklik tombol "Hapus" pada pop-up yang muncul</li>
                                        </ol>
                                        Setelah itu, laporan Anda akan dihapus dari database dan tidak akan tersedia lagi di halaman utama laporan Anda.
                                    </div>
                                </div>
                            </div>
